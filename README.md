Use Captcha and can change font size ratio.
=======
...
* **build($width = 150, $height = 40, $font = null, $fingerprint = null, $fontRatio = 0.8)**, builds a code with the given $width, $height and $font. By default, a random font will be used from the library
